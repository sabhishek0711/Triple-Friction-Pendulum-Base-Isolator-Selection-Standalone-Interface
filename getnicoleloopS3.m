function [p1, p2, p3, p4, p5] = getnicoleloopS3(Rvec, dvec, Hvec, muvec)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% GETNICOLELOOPS3
...
D_sliderconcave = (m1/(2*R1))*(d_slideroutside - d_inner);
...
% D6 should have been calculated here but due to a check, it is calc
%above. Please refer to the above section for D6.
